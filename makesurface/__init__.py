...
import numpy as np
from scripts import tools, datawrite
...
def vectorizeRaster(infile, outfile, classes, classfile, weight, nodata, smoothing, band, cartoCSS, grib2, axonometrize, nosimple):
    ...
    print datawrite.toPolygons(outfile, schema, classRas, breaks, simplest, smoothing, src.crs, nodata, oaff, axonometrize, nosimple)